...
//   return (
//     <div className="bg-gray-50 min-h-screen">
//       {/* 1. State Hero Section - Dynamic Image Background */}
//       <div 
//         className="relative py-24 bg-cover bg-center bg-no-repeat"
//         style={{
//           // TODO: Ensure you have images named like 'florida.jpg' in /public/images/states/
//           backgroundImage: `url('/images/states/${stateData.slug}.jpg')`, 
...
//               <div className="flex items-center justify-between">
//                 <div>
//                   {/* CHANGED: Text is now brand-red by default */}
//                   <h3 className="text-xl font-bold text-brand-red transition-colors">
//                     {city.name}
//                   </h3>
//                   <p className="text-sm text-gray-500 mt-1">
//                     See Local Techs &rarr;
...
//                 </div>
//                 {/* Small Arrow Icon */}
//                 <div className="h-10 w-10 bg-gray-50 rounded-full flex items-center justify-center group-hover:bg-red-50 text-brand-red group-hover:text-brand-red transition-colors">
//                   <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
//                     <path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd" />
//                   </svg>
//                 </div>
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <div 
        className="relative py-24 bg-cover bg-center bg-no-repeat"
        style={{
          // Ensure you have these images or remove this style prop to use the fallback
          // Use state name for image file (e.g. 'alaska.jpg') instead of slug ('ak')
          backgroundImage: `url('/images/states/${stateData.name.toLowerCase().replace(/\s+/g, '-')}.jpg')`, 
          backgroundColor: '#111' 
        }}
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {stateData.cities.map((city) => (
            <Link
              key={city.slug}
              href={`/locations/${stateData.slug}/${city.slug}`}
              className="group block bg-white p-6 rounded-2xl shadow-sm hover:shadow-md transition-all border border-gray-100 hover:border-red-200"
            >
              <div className="flex items-center justify-between">
                <div>
                  {/* --- FIX IS HERE: Changed to text-red-600 --- */}
                  <h3 className="text-xl font-bold text-red-600 group-hover:text-red-700 transition-colors">
                    {city.name}
                  </h3>
                  <p className="text-sm text-gray-500 mt-1">
                    See Local Techs &rarr;
                ...
                {/* Arrow Icon - Also updated to match the red theme */}
                <div className="h-10 w-10 bg-gray-50 rounded-full flex items-center justify-center group-hover:bg-red-50 text-red-600 transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd" />
                  </svg>
                </div>
