...
def generate_database():
    ...
    # 3. Create Specific Branches for Austin
    # FIX: CHANGED NAME TO SERVICEPRO
    branch1 = Branch(
        name="ServicePro Appliance Repair",
        slug="2901-s-capitol-of-texas-highway",
        address="2901 S Capitol of Texas Highway",
        phone="(512) 337-4522",
        zip_code="78746"
    ...
    # --- ADDING ANOTHER STATE (North Dakota) ---
    nd = State(name="North Dakota", slug="nd", abbreviation="ND")
    bismarck = City(name="Bismarck", slug="bismarck", description="Expert technicians in Bismarck.")
    ...
    # 6. Save to the VAULT (src/data/locations.json)
    # FIX: Ensure directory exists and point to correct path
    os.makedirs(os.path.join("src", "data"), exist_ok=True)
    file_path = os.path.join("src", "data", "locations.json")
